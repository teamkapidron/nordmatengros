...
export const metadata: Metadata = {
  title: 'Personvernregler | Nordmat Engros',
};
        ...
        <main className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="mb-8 text-center">
              ...
              <p className="mx-auto max-w-2xl font-[family-name:var(--font-dm-sans)] text-lg text-[var(--nordmat-gray)]">
                Vi respekterer ditt personvern og forplikter oss til å beskytte
                dine personopplysninger
              </p>
            </div>

            <div className="rounded-lg border border-[var(--nordmat-border)] bg-white p-8 shadow-sm">
              <div className="space-y-6">
                <section>
                  <h2 className="mb-4 font-[family-name:var(--font-sora)] text-xl font-semibold text-[var(--nordmat-dark)]">
                  ...
                  <ul className="mt-3 list-disc space-y-2 pl-6 font-[family-name:var(--font-dm-sans)] text-[var(--nordmat-gray)]">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="font-[family-name:var(--font-sora)] font-medium text-[var(--nordmat-dark)]">
                ...
                <div className="mt-8 rounded-lg bg-[var(--nordmat-primary)]/5 p-4">
