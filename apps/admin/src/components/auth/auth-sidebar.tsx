...
function AuthSidebar() {
  return (
    <div className="relative hidden overflow-hidden bg-gradient-to-br from-[var(--nordmat-primary)] to-[var(--nordmat-secondary)] lg:block lg:w-1/2">
        ...
        <div className="max-w-xl text-white">
          <div className="mb-12 text-center lg:text-left">
            <div className="mb-8 flex items-center justify-center space-x-4 lg:justify-start">
              <div className="flex items-center justify-center rounded-xl bg-white/20 p-3 backdrop-blur-sm">
                <Image
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 gap-4 pt-8">
              <div className="flex items-center space-x-3 rounded-lg border border-white/20 bg-white/10 p-4 backdrop-blur-sm">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--nordmat-accent)]">
                  <svg
