...
function SettingsTabs() {
  return (
    <div className="space-y-8">
      <div className="overflow-hidden rounded-2xl border border-[var(--nordmat-border)] bg-white shadow-lg">
        <Tabs defaultValue="profile" className="w-full">
          <div className="bg-gray-50/50 px-8 pt-8 pb-0">
            <TabsList className="min-h-16 w-full rounded-xl border border-[var(--nordmat-border)] bg-white p-1 shadow-sm">
              <TabsTrigger
                value="profile"
                className="flex flex-1 items-center justify-center gap-4 rounded-lg px-8 py-5 font-[family-name:var(--font-dm-sans)] text-base font-medium transition-all duration-200 data-[state=active]:bg-[var(--nordmat-primary)] data-[state=active]:text-white data-[state=active]:shadow-sm"
              >
